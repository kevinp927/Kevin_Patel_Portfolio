...
const About = () => {
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText('kevinpatel0927@gmail.com')
                ...
                <div className="col-span-1 xl:row-span-3">
                    <div className = "grid-container">
                        ...
                        <div>
                            ...
                            <p className = "grid-subtext">With multiple years of Experience, I have honed my skills in frontend and backend development.</p>
                        </div>
                    </div>
                ...
                <div className= "col-span-1 xl:row-span-4">
                    <div className = "grid-container">
                        ...
                        <div>
                            ...
                            <p className="grid-subtext">I'm based in Illinois, and open to work anywhere.</p>
                            <a href="#contact">
                    ...
                    <div className="grid-container">
                        ...
                        <div className = "space-y-2">
                            ...
                            <div className="copy-container" onClick = {handleCopy}>
                                <img src={hasCopied ? 'assets/ticks.svg' : 'assets/copy.svg'} alt = "copy" />
                                <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">kevinpatel0927@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
